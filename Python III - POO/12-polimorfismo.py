'''
Polimordismo: metodos com a mesma assinaruta, porem comportamentos diferentes.
no exemplo do codigo, temos o mesmo metodo def descount, mas em classes diferentes,
aplicando descontos diferentes.
'''
class Phone:
