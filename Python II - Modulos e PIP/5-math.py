'''
Nessa aula vamos aprender a utilizar 
o módulo math na linguagem Python.
Esse módulo serve para facilitar 
cálculos e operações matemáticas na linguagem Python.
'''
...
num1 = 10.3
print(math.ceil(num1)) #cima
print(math.floor(num1)) #baixo
